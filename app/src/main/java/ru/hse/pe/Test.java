...
import ru.hse.pe.deprecated.test.CharacterOfUserTests.Test_BigFive;
import ru.hse.pe.deprecated.test.CharacterOfUserTests.Test_BussPerryAggressionQuestionnaire;
import ru.hse.pe.deprecated.test.CharacterOfUserTests.Test_CognitiveFlexibilityQuestionnaire;
import ru.hse.pe.deprecated.test.CharacterOfUserTests.Test_DiagnosisTemperamentEysenck;
import ru.hse.pe.deprecated.test.CharacterOfUserTests.Test_HardinessSurvey;
import ru.hse.pe.deprecated.test.CharacterOfUserTests.Test_ImplicitTheoriesLearning;
import ru.hse.pe.deprecated.test.CharacterOfUserTests.Test_MultidimensionalPerfectionismScale;
import ru.hse.pe.deprecated.test.CharacterOfUserTests.Test_SandraBoehmGenderRoleQuestionnaire;
import ru.hse.pe.deprecated.test.CharacterOfUserTests.Test_ToleranceToUncertainly;
import ru.hse.pe.deprecated.test.InterpersonalCommunicationTests.Test_AssessmentNeedApproval;
import ru.hse.pe.deprecated.test.InterpersonalCommunicationTests.Test_BornsteinRelationshipProfile;
import ru.hse.pe.deprecated.test.InterpersonalCommunicationTests.Test_Como;
import ru.hse.pe.deprecated.test.InterpersonalCommunicationTests.Test_DiagnosticControlAssessment;
import ru.hse.pe.deprecated.test.InterpersonalCommunicationTests.Test_InterpersonalDependencyInventory;
import ru.hse.pe.deprecated.test.InterpersonalCommunicationTests.Test_LevelEmpathy;
import ru.hse.pe.deprecated.test.InterpersonalCommunicationTests.Test_PEA;
import ru.hse.pe.deprecated.test.InterpersonalCommunicationTests.Test_ScaleLoveSympathy;
import ru.hse.pe.deprecated.test.PsychologicalState.Test_BecksAlarmScale;
import ru.hse.pe.deprecated.test.PsychologicalState.Test_BecksDepressionScale;
import ru.hse.pe.deprecated.test.PsychologicalState.Test_BecksHopelessnessScale;
import ru.hse.pe.deprecated.test.PsychologicalState.Test_DepressionAnxietStress;
import ru.hse.pe.deprecated.test.PsychologicalState.Test_MethodsDiagnosisNeurosis;
import ru.hse.pe.deprecated.test.PsychologicalState.Test_OxfordHappinessQuestionnaire;
