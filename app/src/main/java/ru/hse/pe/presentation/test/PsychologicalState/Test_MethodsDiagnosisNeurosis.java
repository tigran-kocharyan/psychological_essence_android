package ru.hse.pe.presentation.test.PsychologicalState;
...
public class Test_MethodsDiagnosisNeurosis extends AppCompatActivity {
    ...
    private final int countOfQuestions = 40;
    ...
    private final int[] plusResPoints = new int[countOfQuestions];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_methods_diagnosis_neurosis);
    ...
    private void countingCommon(List<RadioButton> pressedRB) {
        ...
        if(sumResPoints >= 24) {
            textViews[1].setText("Высокая вероятность невроза");
            textViews[2].setText(R.string.MDNHighRes);
        }else {
            textViews[1].setText("Низкая невротизация");
            textViews[2].setText(R.string.MDNLowRes);
        }
    }
